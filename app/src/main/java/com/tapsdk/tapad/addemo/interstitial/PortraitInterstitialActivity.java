...
public class PortraitInterstitialActivity extends AppCompatActivity {
    private static final String TAG = "PortraitInterstitial";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.load_interstitial_ad)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                loadAd(PortraitInterstitialActivity.this);
            }
        });
        ...
        ((Button)findViewById(R.id.show_interstitial_ad)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAd(PortraitInterstitialActivity.this);
            }
        });
